...
# Functie om wijzigingen naar GitHub te pushen
...
#def remove_person(idx_planning, checkbox_key, checkbox_checked):
    """Verwijder een persoon uit de aanwezigheid"""
...
if st.session_state.page == "Rooster toevoegen":
    ...
    with st.form("planning_form"):
        ...
        if submit:
            ...
            # Bevestigingsbericht voor toevoegen
            st.success("Rooster toegevoegd: Nieuwe planning is succesvol toegevoegd!")
            st.rerun()  # Herlaad de app om de lijst te updaten
    ...
    if st.session_state.planning.empty:
        ...
        if st.button("Opslaan"):
           ...
           # )
            ...
            # Bevestigingsbericht voor bewerken
            st.success(f"Rooster bewerkt: '{taak}' is succesvol aangepast!")
            st.rerun()  # Herlaad de app om de lijst te updaten
        ...
        if st.button("Verwijder deze planning"):
            ...
            # Bevestigingsbericht voor verwijderen
            st.success(f"Rooster verwijderd: '{planning_select}' is succesvol verwijderd!")
            st.rerun()  # Herlaad de app om de lijst te updaten
